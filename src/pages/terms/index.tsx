            ...
            <MainCard elevation={4} border={false} boxShadow shadow="4" sx={{ mb: 3 }}>
              <div>
                <div className="p-5">
                  ...
                  <div style={{ textAlign: 'left' }}>1. AGREEMENT TO TERMS</div>
                  <div style={{ textAlign: 'left' }}>2. INTELLECTUAL PROPERTY RIGHTS</div>
                  <div style={{ textAlign: 'left' }}>3. USER REPRESENTATIONS</div>
                  <div style={{ textAlign: 'left' }}>4. USER REGISTRATION</div>
                  <div style={{ textAlign: 'left' }}>5. FEES AND PAYMENT</div>
                  <div style={{ textAlign: 'left' }}>6. CANCELLATION</div>
                  <div style={{ textAlign: 'left' }}>7. PROHIBITED ACTIVITIES</div>
                  <div style={{ textAlign: 'left' }}>8. USER GENERATED CONTRIBUTIONS</div>
                  <div style={{ textAlign: 'left' }}>9. CONTRIBUTION LICENSE</div>
                  <div style={{ textAlign: 'left' }}>10. GUIDELINES FOR REVIEWS</div>
                  <div style={{ textAlign: 'left' }}>11. SOCIAL MEDIA</div>
                  <div style={{ textAlign: 'left' }}>12. SUBMISSIONS</div>
                  <div style={{ textAlign: 'left' }}>13. THIRD-PARTY WEBSITES AND CONTENT</div>
                  <div style={{ textAlign: 'left' }}>14. U.S. GOVERNMENT RIGHTS</div>
                  <div style={{ textAlign: 'left' }}>15. SITE MANAGEMENT</div>
                  <div style={{ textAlign: 'left' }}>16. PRIVACY POLICY</div>
                  <div style={{ textAlign: 'left' }}>17. TERM AND TERMINATION</div>
                  <div style={{ textAlign: 'left' }}>18. MODIFICATIONS AND INTERRUPTIONS</div>
                  <div style={{ textAlign: 'left' }}>19. GOVERNING LAW</div>
                  <div style={{ textAlign: 'left' }}>20. DISPUTE RESOLUTION</div>
                  <div style={{ textAlign: 'left' }}>21. CORRECTIONS</div>
                  <div style={{ textAlign: 'left' }}>22. DISCLAIMER</div>
                  <div style={{ textAlign: 'left' }}>23. LIMITATIONS OF LIABILITY</div>
                  <div style={{ textAlign: 'left' }}>24. INDEMNIFICATION</div>
                  <div style={{ textAlign: 'left' }}>25. USER DATA</div>
                  <div style={{ textAlign: 'left' }}>26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</div>
                  <div style={{ textAlign: 'left' }}>27. CALIFORNIA USERS AND RESIDENTS</div>
                  <div style={{ textAlign: 'left' }}>28. MISCELLANEOUS</div>
                  <div style={{ textAlign: 'left' }}>29. CONTACT US</div>
                  <p>
                    <br />
                  </p>
                  <div id="agreement">
                ...
                <div className="p-5">
                  <div>
                    ...
                    behalf of an entity (&ldquo;you&rdquo;) and&nbsp;Aivinya Inc., doing business as&nbsp;InfraHive&nbsp;(&quot;
                    <strong>InfraHive</strong>&quot;, &ldquo;<strong>we</strong>&rdquo;, &ldquo;
                    <strong>us</strong>&rdquo;, or &ldquo;<strong>our</strong>&rdquo;), concerning your access to and use of the&nbsp;
                    ...
                    otherwise connected thereto (collectively, the &ldquo;Site&rdquo;).&nbsp;We have registered office at&nbsp;1882, 1007 N
                    Orange St. 4th Floor , Wilmington, DE, New Castle, US, 19801 .&nbsp;You agree that by accessing the Site, you have read,
                    understood, and agree to be bound by all of these&nbsp;Terms of Service. IF YOU DO NOT AGREE WITH ALL OF
                    THESE&nbsp;TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE
                    IMMEDIATELY.
                  </div>
                </div>
                <div>
                ...
                <div className="p-5">
                  <div>
                    ...
                    these&nbsp;Terms of Service&nbsp;from time to time. We will alert you about any changes by updating the &ldquo;Last
                    updated&rdquo; date of these&nbsp;Terms of Service, and you waive any right to receive specific notice of each such
                    change. Please ensure that you check the applicable Terms every time you use our Site so that you understand which Terms
                    apply. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any
                    revised&nbsp;Terms of Service&nbsp;by your continued use of the Site after the date such revised&nbsp;Terms of
                    Service&nbsp;are posted.
                  </div>
                </div>
                <div>
                ...
                <div className="p-5">
                  ...
                  <div>
                    ...
                    such laws, you may not use this Site. You may not use the Site in a way that would violate the Gramm-Leach-Bliley Act
                    (GLBA).
                  </div>
                  <div>
                    <br />
                ...
                <div className="p-5">
                  <div>
                    ...
                    &ldquo;Content&rdquo;) and the trademarks, service marks, and logos contained therein (the &ldquo;Marks&rdquo;) are
                    ...
                    international conventions. The Content and the Marks are provided on the Site &ldquo;AS IS&rdquo; for your information
                    and personal use only. Except as expressly provided in these&nbsp;Terms of Service, no part of the Site and no Content
                    or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated,
                ...
                <div className="p-5">
                  <div>
                    ...
                    registration information&nbsp;as necessary; (3) you have the legal capacity and you agree to comply with
                    these&nbsp;Terms of Service;&nbsp;(4) you are not a minor in the jurisdiction in which you reside;&nbsp;(5) you will not
                    access the Site through automated or non-human means, whether through a bot, script or otherwise;&nbsp;(6) you will not
                    use the Site for any illegal or unauthorized purpose; and (7) your use of the Site will not violate any applicable law
                    or regulation.
                  </div>
                </div>
                <div>
                ...
                <div className="p-5">
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      that we can complete your transactions and contact you as needed. We bill you through an online billing account for
                      purchases made via the Site. Sales tax will be added to the price of purchases as deemed required by us. We may change
                  ...
                  <div>
                    <div>
                      If you are unsatisfied with our services, please email us at&nbsp;kunal@infrahive.io&nbsp;or call us
                      at&nbsp;917014114843.
                    </div>
                    <div>
                      <br />
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        party&rsquo;s uninterrupted use and enjoyment of the Site or modifies, impairs, disrupts, alters, or interferes with
                      ...
                      <li>
                        ...
                        (&ldquo;gifs&rdquo;), 1&times;1 pixels, web bugs, cookies, or other similar devices (sometimes referred to as
                        &ldquo;spyware&rdquo; or &ldquo;passive collection mechanisms&rdquo; or &ldquo;pcms&rdquo;).
                      </li>
                      <li>
                      ...
                      <li>
                        Make any unauthorized use of the Site, including collecting usernames and/or email addresses of users by electronic
                ...
                <div className="p-5">
                  ...
                  <div>
                    <div>
                      <div>
                        ...
                        other users of the Site and through third-party websites. As such, any Contributions you transmit may be treated in
                        accordance with the Site Privacy Policy. When you create or make available any Contributions, you thereby represent
                        and warrant that:
                      </div>
                      <ul>
                        <li>
                        ...
                        <li>
                          ...
                          inclusion and use of your Contributions in any manner contemplated by the Site and these&nbsp;Terms of Service.
                        </li>
                  ...
                  <div>
                    ...
                    <div>
                      <div id="reviews">
                        <strong>10. GUIDELINES FOR REVIEWS</strong>
                      </div>
                    </div>
                    <div>
                      <br />
                    ...
                    <div>
                      <div>
                        ...
                        the Site (&quot;Submissions&quot;) provided by you to us are non-confidential and shall become our sole property. We
                        ...
                        be no recourse against us for any alleged or actual infringement or misappropriation of any proprietary right in
                        your Submissions.
                      </div>
                      <div>
                        <br />
                      ...
                      <div>
                        <div id="thirdparty">
                          <strong>13. THIRD-PARTY WEBSITES AND CONTENT</strong>
                        </div>
                      </div>
                      <div>
                        <br />
                      ...
                      <div>
                        <div>
                          ...
                          installed from the Site, including the content, accuracy, offensiveness, opinions, reliability, privacy practices,
                          or other policies of or contained in the Third-Party Websites or the Third-Party Content. Inclusion of, linking
                          ...
                          use or install any Third-Party Content, you do so at your own risk, and you should be aware these&nbsp;Terms of
                          Service&nbsp;no longer govern. You should review the applicable terms and policies, including privacy and data
                          gathering practices, of any website to which you navigate from the Site or relating to any applications you use or
                          install from the Site. Any purchases you make through Third-Party Websites will be through other websites and from
                          ...
                          services offered on Third-Party Websites and you shall hold us harmless from any harm caused by your purchase of
                          such products or services. Additionally, you shall hold us harmless from any losses sustained by you or harm
                          caused to you relating to or resulting in any way from any Third-Party Content or any contact with Third-Party
                          Websites.
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        <div id="usrights">
                          <strong>14. U.S. GOVERNMENT RIGHTS</strong>
                        </div>
                      </div>
                      <div>
                        <br />
                      ...
                      <div>
                        <div>
                          Our services are &ldquo;commercial items&rdquo; as defined in Federal Acquisition Regulation (&ldquo;FAR&rdquo;)
                          2.101. If our services are acquired by or on behalf of any agency not within the Department of Defense
                          (&ldquo;DOD&rdquo;), our services are subject to the terms of these&nbsp;Terms of Service&nbsp;in accordance with
                      ...
                      <div id="sitemanage">
                        <strong>15. SITE MANAGEMENT</strong>
                      </div>
                    </div>
                    <div>
                      <br />
                    ...
                    <div>
                      <div>
                        ...
                        these&nbsp;Terms of Service, including without limitation, reporting such user to law enforcement authorities; (3)
                        in our sole discretion and without limitation, refuse, restrict access to, limit the availability of, or disable (to
                    ...
                    <div>
                      <div>
                        <div>
                          We care about data privacy and security. By using the Site, you agree to be bound by our Privacy Policy posted on
                          the Site, which is incorporated into these&nbsp;Terms of Service. Please be advised the Site is hosted
                          in&nbsp;India. If you access the Site from any other region of the world with laws or other requirements governing
                          personal data collection, use, or disclosure that differ from applicable laws in&nbsp;India, then through your
                          continued use of the Site, you are transferring your data to&nbsp;India, and you agree to have your data
                    ...
                    <div>
                      <div id="terms">
                        <strong>17. TERM AND TERMINATION</strong>
                      </div>
                    </div>
                    <div>
                      <br />
                    ...
                    <div>
                      <div>
                        ...
                        OTHER PROVISION OF THESE&nbsp;TERMS OF SERVICE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE
                        OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY
                        ...
                        PARTICIPATION IN THE SITE OR DELETE&nbsp;YOUR&nbsp;ACCOUNT AND&nbsp;ANY CONTENT OR INFORMATION THAT YOU POSTED AT
                    ...
                    <div>
                      ...
                      <div id="modifications">
                        <strong>18. MODIFICATIONS AND INTERRUPTIONS</strong>
                      </div>
                    </div>
                    <div>
                      <br />
                    ...
                    <div>
                      <div>
                        ...
                        right to modify or discontinue all or part of the Site without notice at any time. We will not be liable to you or
                    ...
                    <div>
                      <div>
                        ...
                        by your inability to access or use the Site during any downtime or discontinuance of the Site. Nothing in
                        these&nbsp;Terms of Service&nbsp;will be construed to obligate us to maintain and support the Site or to supply any
                    ...
                    <div>
                      ...
                      <div>
                        These Terms shall be governed by and defined following the laws of&nbsp;India.&nbsp;BlockBridge Private
                        Limited&nbsp;and yourself irrevocably consent that the courts of&nbsp;India&nbsp;shall have exclusive jurisdiction
                    ...
                    <div>
                      <div>
                        ...
                        Service&nbsp;(each &quot;Dispute&quot; and collectively, the &ldquo;Disputes&rdquo;) brought by either you or us
                        (individually, a &ldquo;Party&rdquo; and collectively, the &ldquo;Parties&rdquo;), the Parties agree to first
                    ...
                    <div>
                      ...
                      ABOUT THE ACCURACY OR COMPLETENESS OF THE SITE&rsquo;S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND
                      WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS,
                      ...
                      VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY
                      ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE
                      OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE,
                      OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE, ANY
                      ...
                      PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU
                    ...
                    <div id="liability">
                      <strong>23. LIMITATIONS OF LIABILITY</strong>
                    </div>
                    <div>
                      <br />
                    </div>
                    <div>
                      ...
                      AMOUNT PAID, IF ANY, BY YOU TO US&nbsp;&nbsp;DURING THE&nbsp;THREE (3)&nbsp;MONTH PERIOD PRIOR TO ANY CAUSE OF
                      ACTION&nbsp;ARISING&nbsp;OR&nbsp;__________.&nbsp;CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
                      LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME
                    ...
                    <div id="indemnification">
                      <strong>24. INDEMNIFICATION</strong>
                    </div>
                    <div>
                      <br />
                    </div>
                    <div>
                      ...
                      including reasonable attorneys&rsquo; fees and expenses, made by any third party due to or arising out of:&nbsp;(1)
                      use of the Site; (2) breach of these&nbsp;Terms of Service; (3) any breach of your representations and warranties set
                      forth in these&nbsp;Terms of Service; (4) your violation of the rights of a third party, including but not limited to
                    ...
                    <div id="electronic">
                      <strong>26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong>
                    </div>
                    <div>
                      <br />
                    </div>
                    <div>
                      ...
                      RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR
                      VIA THE SITE. You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances, or other
                      laws in any jurisdiction which require an original signature or delivery or retention of non-electronic records, or to
                    ...
                    <div id="misc">
                      <strong>28. MISCELLANEOUS</strong>
                    </div>
                    <div>
                      <br />
                    </div>
                    <div>
                      ...
                      Site constitute the entire agreement and understanding between you and us. Our failure to exercise or enforce any
                      right or provision of these&nbsp;Terms of Service&nbsp;shall not operate as a waiver of such right or provision.
                      These&nbsp;Terms of Service&nbsp;operate to the fullest extent permissible by law. We may assign any or all of our
                      rights and obligations to others at any time. We shall not be responsible or liable for any loss, damage, delay, or
                      failure to act caused by any cause beyond our reasonable control. If any provision or part of a provision of
                      these&nbsp;Terms of Service&nbsp;is determined to be unlawful, void, or unenforceable, that provision or part of the
                      ...
                      created between you and us as a result of these&nbsp;Terms of Service&nbsp;or use of the Site. You agree that
                      these&nbsp;Terms of Service&nbsp;will not be construed against us by virtue of having drafted them. You hereby waive
                      any and all defenses you may have based on the electronic form of these&nbsp;Terms of Service&nbsp;and the lack of
                    ...
                    <div>
                      <strong>Aivinya Inc.</strong>
                    </div>
                    <div>
                      <strong>144, Subhash Chowk,</strong>
                    </div>
                    <div>
                      <strong>
                        Jaipur<strong>,&nbsp;Rajasthan</strong>
                        <strong>&nbsp;302002</strong>
                      </strong>
                    </div>
                    <div>
                      <strong>
                    ...
                    <div>
                      <strong>Phone:&nbsp;917014114843</strong>
                    </div>
                    <div>
                      <strong>kunal@infrahive.io</strong>
                    </div>
                  </div>
                </div>
              </div>
