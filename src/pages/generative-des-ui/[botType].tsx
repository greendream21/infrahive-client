...
import { Box, Button, Drawer, Grid, Paper, Stack, Tab, Typography } from "@mui/material";
// import List from "pages/api/mails/list";
...
import List from "pages/dashboard/texts/list";
...
const UI = () => {
    ...
    const goTextGenerate =async () => {
        router.push(`/text-generate/${mode}`);
    }
                ...
                <Paper sx={{ width: '100%', p: 5, pb: 0 }}>                  
                    <Stack justifyContent={"center"} spacing={3} p={1} sx={{
                        ...
                        <Stack direction="row" spacing={2}>
                            <Button color='primary' variant='contained' onClick={goTextGenerate}>OPEN PROMPT DESIGN</Button>
                            ...
                            >
                                <Stack justifyContent={"center"} spacing={3} p={6} >
                                    <Stack width={'750px'} justifyContent={"center"} spacing={3} >                                    
                                        ...
                                        <Button color='primary' variant='outlined' startIcon={<AddIcon />} sx={{width: '200px'}} onClick={goTextGenerate}>Create PROMPT</Button>
                                        <hr />
                                        <List mode={mode} />
                                    </Stack>
                                </Stack>
